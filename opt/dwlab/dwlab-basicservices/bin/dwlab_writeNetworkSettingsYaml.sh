...
# ----------------------------------------
if $verbose; then
  echo "DW-Lab: YAML file: $yamlFile"
...
{
  echo "# $yamlFile"
  echo "# This file shows all IP addresses and their corresponding hostnames"
  echo "# The file has been generated after the cmkcentralclient was installed"
  echo "# To recreate this file run the following command:"
  echo "# $thisScript"
  echo "hostsettings:"
} > "$yamlFile"
